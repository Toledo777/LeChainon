...
housing_placements_bp = Blueprint(
    "housing_placements", __name__, url_prefix="/housing_placements"
)
...
def create_housing_placements():
    data = {
        ...
        "housing_id": request.json.get("housing_id"),
...
def get_housing_placemnents_data():
    ...
    return (
        jsonify(
            {"message": "Success!", "housing_placements_data": housing_placements_data}
        ),
        200,
    )
