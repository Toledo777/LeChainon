...
export default function AppView() {
  ...
  const [chronologicalNotes, setChronologicalNotes] = useState([
    ...
    },
    {
      ...
      type: 'appointment',
      details:
        'The coordinator came to offer her this appointment, easy to access, to talk with a doctor about her symptoms, (as mentioned since the beginning of February) who has test or analysis results to communicate to her. ',
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let response = await fetch(
        'http://localhost:8000/intervention/get-intervention-plan',
        requestOptions
      );
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} sm={6} md={3}>
            <AppWidgetSummary
              title={
                residentNum / caretakerNum > 1
                  ? 'Caretakers Per Resident'
                  : 'Caretaker Per Resident'
              }
              ...
              list={[
                {
                  ...
                  value: '80%',
                  icon: (
                    <img src="/assets/icons/glass/ic_glass_reward.png" width={32} alt="success" />
                  ),
                },
                {
                ...
                },
                {
                  ...
                  icon: (
                    <img
                      src="/assets/icons/glass/ic_glass_duration.png"
                      width={32}
                      alt="duration"
                    />
                  ),
                },
                {
                  ...
                  icon: (
                    <img
                      src="/assets/icons/glass/ic_glass_health.png"
                      width={32}
                      alt="health_aspect"
                    />
                  ),
